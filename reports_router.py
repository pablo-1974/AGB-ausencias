...
#  - user  = Jefe de Estudios (emisión de partes)
#  - admin = Administrador
#  - La autorización se controla solo por dependencias
#
# Nota:
...
async def reports_daily_form(
    ...
    return _templates(request).TemplateResponse(
        "reports_daily.html",
        ctx(request, user, title="Parte diario de ausencias", today=today_str),
    )


# ======================================================
# PARTE DIARIO — vista previa
# /reports/daily/view (GET)
# ACCESO: user
# ======================================================
