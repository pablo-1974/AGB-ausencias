...
class ActionType(str, Enum):
    """
    Tipos de acciones administrativas registrables en el sistema.
    Se usan para evitar strings libres en los logs.
    """
    ...
    TEACHER_STATUS_CHANGE = "teacher_status_change"

    # Ausencias
    ABSENCE_CREATE = "absence_create"
    ABSENCE_UPDATE = "absence_update"
    ABSENCE_DELETE = "absence_delete"
    ABSENCE_CATEGORIZE = "absence_categorize"

    # Bajas y sustituciones
    LEAVE_CREATE = "leave_create"
    SUBSTITUTION_CREATE = "substitution_create"
    LEAVE_CLOSE_CASCADE = "leave_close_cascade"
    LEAVE_CLOSE_SUBTREE = "leave_close_subtree"
    ...
    CALENDAR_HOLIDAY_ADD = "calendar_holiday_add"
    CALENDAR_HOLIDAY_REMOVE = "calendar_holiday_remove"
