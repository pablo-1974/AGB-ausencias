# services/pdf_monthly.py — VERSIÓN FINAL con lógica de cadenas de sustituciones
...
from models import Absence, Leave, Teacher, ScheduleSlot, SchoolCalendar, TeacherStatus
...
async def working_school_days(
    ...
    while cur <= end:
        ...
        if weekday >= 5 or is_holiday(cur, cal) or not await professor_works_day(session, teacher_id, cur):
...
# =====================================================================
# AUSENCIAS compactadas (sin cambios grandes)
# =====================================================================
...
async def build_monthly_report_pdf(
    ...
    if has_uncategorized:
        aviso = '<font color="red"><b>AVISO:</b> Existen AUSENCIAS sin catalogar.</font>'
    ...
    return has_uncategorized, rows, rows_html
