...
# ======================================================================
#   PDF PRINCIPAL (con estética antigua restaurada)
# ======================================================================
async def build_daily_report_pdf(
    ...
    for label, hour_idx in HOUR_ROWS:
        ...
        for tid in guard_ids:
            ...
            # ✅ Filtro NUEVO: sustituto sin empezar → no guardia
    ...
    # ===================================================================
    #   MAQUETACIÓN PDF — ESTÉTICA ANTIGUA COMPLETA
    # ===================================================================
    ...
    # Caja observaciones (altura fija)
    parts = []
    ...
    # Anchos proporcionales antiguos
    col_widths = [
        1.0 * cm,
        total_width * 0.32,
        total_width * 0.10,
    ...
    # Alturas de filas antiguas (SPAN en recreo)
    row_heights = [16] + [
...
# ======================================================================
#   HTML PREVIEW — armonizada con el PDF
# ======================================================================
async def build_daily_report_data(
    ...
    for label, hour_idx in HOUR_ROWS:
        ...
        # GUARDIAS ACTIVOS (con el MISMO filtro)
        guard_ids = await list_teachers_on_guard(
            session, weekday_py, hour_idx, absent_ids
        )
