...
#   FIX: escoger la BAJA MÁS PROFUNDA ACTIVA EN LA FECHA
# ======================================================================
async def _teachers_absent_that_day(
    ...
    # Construir árboles reales mediante parent_leave_id
...
async def build_daily_report_pdf(
    ...
    for label, hour_idx in HOUR_ROWS:
        ...
        for tid in guard_ids:
            ...
            # Sustituto que aún no ha empezado → no guardia
